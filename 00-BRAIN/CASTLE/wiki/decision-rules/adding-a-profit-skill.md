...
Serves a defined reporting workflow (Phase 3–5), the BUSINESS/PYTHON evidence homes
cover it, the phase is near, it displaces a lower-value formatting task, and proof
is one real report rendered and used. → skill map.

...
Load `HAT_EDUCATOR_PLAYBOOKS.md` for the detailed method needed. Core methods are Skeleton First, One Concept at a Time, Term Anchoring, Explain-It-Back, Cold Checks, Physical Anchors, and Short Corrections During Reps.

Available procedures: Education Session, Code Session, Pre-Semester Prep, and Stage Advance. “Boring and working” beats clever during early code reps.

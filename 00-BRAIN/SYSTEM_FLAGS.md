...
### Last updated: August 11, 2026 — flags #92 and #95 closed; flag #96 opened (residual journal/raw write exposure to spawned child processes, visible only from WSL) and given a third mitigation, the `PreToolUse` bulk-work gate. No HIGH flags open.

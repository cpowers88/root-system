...
| draft | Structured but not tested |
| tested internally | Used in a practice audit, project, or personal workflow |
| client-ready | Clear enough to show or use with a prospect/client |
| deployed | Used in live paid or serious field work |

## Index Rule

Every new asset gets one row here the same day it is created. If an asset is retired, keep the row and change the maturity or move the asset to archive; do not silently delete the record.

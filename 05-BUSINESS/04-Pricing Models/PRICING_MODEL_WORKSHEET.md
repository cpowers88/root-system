...
|---|---|---|
| First 2–3 audits (proof phase, 2027) | free or $250–500 | ⚠ |
| Standard audit after proof | $750–1,500 | ⚠ |
| Time budget per audit | 1 site day + 1 writing day | ⚠ |

Anchor sentence for the sales conversation:
...
| Variable | Placeholder | Chris decides |
|---|---|---|
| Small fix (config, one integration) | $500–1,500 | ⚠ |
...
## Open Decisions (answer at a strategy session, not mid-sale)

1. Free first audits for proof, or discounted-but-paid? (Free = faster
   yes, weaker anchor. Paid = fewer takers, real testimonials.)
2. Guarantee language — use it, and at what multiple?

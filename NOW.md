...
| `.ROOT` | Gate 0 plus CASTLE Slices A0 and A1 installed; the North Star and four entrance files now match the July 19 operating contract, with predecessors archived | Review and commit the bounded A1 diff; then present Slice A2 core-map wording for approval. Slice C remains folded into the July 26 sweep, alongside the July 24–26 `check_at` outcomes |

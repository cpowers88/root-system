...
|---|---|---|---|---|
| S-01 | Owners will value and pay for a concise observation-based waste audit | real conversations, willingness to pay, completed report feedback | BUSINESS wiki + CASTLE opportunity queue | first 3 qualified conversations or March 2027 |
| S-02 | Real estate is the fastest warm-access wedge | number and quality of workflow conversations and introductions | BUSINESS evidence / field notes | first-contact phase review |
...
|---|---|---|
| Continuity income | Before Spring 2027 enrollment | `.ROOT` converts capability to timely value |
| Observation method practiced live | Before first offer | audit begins from real evidence, not theory |
| First paid consulting conversation | March 2027 | market access and problem framing create interest |
| First paid audit report | H1 2027 | the first offer creates enough value to buy |
| First retainer client | By December 2027 | a report can earn recurring work |
...
| First recurring non-service asset income | 2029 | harvested assets earn beyond direct labor |
| $100K annual run rate | 2029 | model supports a real company trajectory |
| $250K+ | 2030 | leverage and asset compounding are working |
| $500K–$1M annual floor | October 8, 2031 | North Star floor reached or ratcheted higher |

A missed milestone requires diagnosis — market, access, offer, execution,
timing, capacity, measurement — before the vehicle changes.
...
---
*Human context and rationale: folder `HOW_TO_USE.md` (pending).*

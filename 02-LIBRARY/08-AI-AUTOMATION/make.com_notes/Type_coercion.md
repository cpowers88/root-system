...
image: https://archbee-image-uploads.s3.amazonaws.com/oAyFj2GHlBeBVWF5OAir2/4vkDK6AFGxP9Xd1sZdBup_domino-zoomin-purple-a-1.png
docTags: 
...
| **text**     | Make will try to convert the text to a date. If the conversion fails, it will return a validation error. Date must contain day, month and year. Date may contain time and time zone. Default time zone is based on your settings. See these [examples](https://help.make.com/type-coercion#RNPRI). |

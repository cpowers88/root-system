...
## Why It Matters
- **Named third-party evidence for exactly this transition.** The WEF Future of Jobs Report 2025 (intake 2026-07-12, `raw/`, 1,000+ employers/22 industries/55 economies) names the fastest-*declining* roles globally: Cashiers/Ticket Clerks, **Administrative Assistants and Executive Secretaries (the largest absolute decline of any role)**, Postal Clerks, Bank Tellers, Data Entry Clerks — and new this edition, Graphic Designers and Legal Secretaries, both attributed explicitly to generative AI. These are the Producer-role case exactly: the 15-year admin in this page's Key Idea example is a real, named, globally-tracked category, not a hypothetical — cite the report directly when a discovery call raises "what happens to my office staff." Net effect globally is still positive (170M jobs created vs. 92M displaced, +78M net) — useful to frame the redesign as industry-wide reallocation, not elimination.
...
6. **Report the shift to the owner:** hours moved from production to revenue/judgment work is a headline metric in the [[05-BUSINESS/03-Case Studies/CASE_STUDY_TEMPLATE|case study]].

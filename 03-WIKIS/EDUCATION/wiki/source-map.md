...
| `raw/Syllabi/TCOM 2010 04 (85633) Fall 2026 Syllabus.md` | **Controlling exact-section capture**, recaptured 2026-07-27 and read end to end 2026-08-19 | Covered — [[course-briefs/fall-2026-course-briefs]], [[courses/tcom-2010/semester-map]], [[courses/tcom-2010/tcom-2010-17-week-execution-plan]]. The older root-level raw copy is historical; use this `Syllabi/` copy for meeting information, policies, weights, and relative week order. Printed January dates are recycled and do not control Fall dates. |
| `raw/Syllabi/ENGR 1000 Section BD (81208) Introduction to Engineering.md` and `raw/Syllabi/ENGR 1000 Section 05 (81217) Introduction to Engineering.md` | Fall 2025, wrong sections/instructors; historical standardized-course evidence | Covered as reference only — [[course-briefs/fall-2026-course-briefs]]. Superseded for provisional structure by three neighboring Fall 2026 web captures in `77-INBOX`, but retained as immutable evidence. None can control BWD dates or execution. Open flag #57. |
| `raw/Open-TC_Course-Resources/Open-TC-PDF.pdf` and `raw/Textbook Doc Files/Open Technical Communication.pdf` | The assigned 2019 decimal-numbered edition of *Open Technical Communication*; these copies align to the syllabus chapter numbers | Covered — [[courses/tcom-2010/semester-map]]. Do not navigate by `raw/Textbook Doc Files/2e_Word/`; its flat renumbering conflicts with the syllabus. |

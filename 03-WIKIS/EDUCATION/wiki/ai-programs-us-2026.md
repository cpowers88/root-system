...
**Sources (in `raw/`):**
- `AI Programs in U.S. Universities.md` — web clipping of [cicmap.ai](https://cicmap.ai/) (Center for Inclusive Computing, Northeastern Univ.), captured July 8, 2026; site data as of June 15, 2026
- `2606.12428v1.pdf` — Muzny et al., *"Mapping AI Programs in the U.S.: A Status Report from Early 2026 and an Analysis of AI Majors and Minors"* (arXiv:2606.12428, May 2026); analysis snapshot April 2026
...
distillation in `03-WIKIS\AI_AUTOMATION_SYSTEMS\wiki\ai-index-2026.md`) —
...
- **4 in 5 US high-school and college students use AI for schoolwork**;
  ...
  [[fall-2026-course-briefs]] is the national norm, not a KSU quirk).

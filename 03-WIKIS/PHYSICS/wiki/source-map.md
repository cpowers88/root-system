...
| `raw/syllabus/PHYS 2211 51 (83719) Fall 2026 Syllabus - Reference Only.md` | reference (neighbor section) | n/a | Cross-check on topic order, pacing, exam timing | Do not treat as Chris's binding schedule | Section 51, instructor Krishna Rana Magar. Full 18-week calendar, but the date column is internally out of chronological order from Week 9 onward (garbled table) — use topic sequence and week numbers, not the printed day/date pairs. Reaches Ch 16-17 (waves) but never schedules Ch 14 (fluids) or Ch 38 (relativity). See [[syllabus-coverage-ledger#Cross-Section Verification, 2026-07-21]]. |

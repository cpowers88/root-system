...
- **Term:** Fall 2026, Section 55
- **Instructor:** Dr. Swayamprabha Behera (sbehera@kennesaw.edu)
...
| `raw/syllabus/PHYS 2211 51 (83719) Fall 2026 Syllabus - Reference Only.md` | reference (neighbor section) | n/a | Cross-check on topic order, pacing, exam timing | Do not treat as Chris's binding schedule | Immutable July 21 capture omitted the top instructor block. A July 27 school-library recapture identifies Farhan Islam (`fislam7@kennesaw.edu`) and Chris reports that the current online listing also names Farhan for his Section 54, making Farhan the provisional likely instructor. This is not an exact-section syllabus confirmation: Section 51 grading, dates, and policies remain nonbinding. The raw/library copies diverge under HIGH flag #85. |
| `raw/syllabus/PHYS 2211 55 (83723) Fall 2026 Syllabus - Reference Only.md` | reference (neighbor section, closest match) | n/a | Cross-check on topic order, pacing, exam timing; best available real Fall-2026 calendar | Do not treat as Chris's binding schedule | Section 55, instructor Swayamprabha Behera — same instructor as `syllabus.pdf`. Full week-by-week calendar through mid-December with real 2026 dates and 3 exam dates (Sep 25, Oct 30, Nov 20). Calendar stops after Ch 15 (SHM) — never reaches Ch 13 (gravitation, though mentioned in the course description), Ch 14 (fluids), Ch 16-17 (waves), or Ch 38 (relativity). See [[syllabus-coverage-ledger#Cross-Section Verification, 2026-07-21]]. |

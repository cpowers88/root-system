...
|---|---|---:|---|---|---|
| `syllabus.pdf` — **superseded, archived 2026-07-21; no longer at `raw/syllabus/`** | spine (historical; policy, provisional schedule) | n/a | Course outcomes, grading categories, AI policy, early topic order — now superseded by the two real syllabi below | — | All 19 pages visually reviewed 2026-07-15 and accounted in [[syllabus-coverage-ledger]]; those findings are preserved below as historical record. Calendar only listed through Ch.5 and contained recycled/conflicting details; see the data-quality gate below. Cross-check 2026-07-21 confirmed this file's instructor, grading weights (HW10/quiz5/participation10/3exams45/final30), and early-week dates all matched `PHYS 2211 55` almost exactly — it was an earlier, truncated capture of the same Section 55 syllabus, not an independent source. It has since been moved to `99-ARCHIVE\02-LIBRARY\00-SCHOOL\SYLLABI_REPLACED_2026-07-21\02-Physics I\syllabus.pdf`; do not cite `raw/syllabus/syllabus.pdf` as a live path. Use D2L for dates, deadlines, and exam/drop mechanics, and the two Reference-Only section syllabi below as the current best-available real sources. |
| `raw/syllabus/PHYS 2211 51 (83719) Fall 2026 Syllabus - Best copy.md` | controlling preparation-path source | n/a | Topic scope and study order because it matches Chris's Fall term and instructor | Do not treat Section 51 dates, CRN, grading, or policies as binding on Section 54 | Chris explicitly selected this as path truth on 2026-07-28 until he says otherwise. Follow topic names when its printed chapter-number cells conflict with the textbook; use Serway to locate the correct content. |
| `02-LIBRARY/00-SCHOOL/02-Physics I/PHYS 2211 55 (83723) Fall 2026 Syllabus - Reference Only.md` | secondary reference (neighbor section, different instructor) | n/a | Cross-check broad topic order and semester compression | Do not treat as Chris's schedule or instructor policy | Section 55, instructor Swayamprabha Behera. Its calendar is useful corroboration but is weaker than Section 51 for Chris. |

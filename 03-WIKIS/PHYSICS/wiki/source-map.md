...
| `04-SCHOOL/02-Physics I/PHYS 2211 55 (83723) Fall 2026 Syllabus - Reference Only.md` | secondary reference (neighbor section, different instructor) | n/a | Cross-check broad topic order and semester compression | Do not treat as Chris's schedule or instructor policy | Section 55, instructor Swayamprabha Behera. Its calendar is useful corroboration but is weaker than Section 51 for Chris. |

...
# Physics Education Wiki Index

## Course

PHYS 2211 — Principles of Physics I, Kennesaw State University, Fall 2026.

## Appendix Reference (vital reference for all 18 stages)

- [[appendix/index]] — appendix navigation page
- [[appendix/si-units]] — 7 SI base units, derived units, SI prefixes
- [[appendix/conversion-factors]] — Table A.1: length, mass, time, speed, force, energy, pressure
- [[appendix/quantity-table]] — Table A.2: every physical quantity → symbol, dimensions, SI unit
- [[appendix/math-algebra]] — B.1 scientific notation; B.2 algebra
- [[appendix/math-geometry-trig]] — B.3 geometry; B.4 trigonometry
- [[appendix/math-calculus]] — B.5 series; B.6 derivatives; B.7 integrals
- [[appendix/uncertainty]] — B.8 propagation of uncertainty (labs)
...
- [[concept-map]] — concept dependency map
...
- [[authoring-standards]] — page formats, core-file specs, intake + session protocols (load when creating pages)
...
- `parked-advanced/` — none yet (see [[parking-lot]] for parked chapters)
- `appendix/` — 8 reference pages from Serway & Jewett appendices (built 2026-06-25)

Navigation is stage-first: each stage packet links its stage's concepts,
equations, drills, and checks. This index lists maps and the active stage,
not every page. Packet pages reference some drill/problem-type/equation
pages that are not yet generated — those are planned-page links, tracked by
the monthly lint pass, and get created or consolidated as stages activate.
The 2026-07-15 source screen found no live broken link, but later-stage planned
links remain intentionally incomplete; [[learning-path]] records which gaps are
content decisions versus missing supporting pages.
